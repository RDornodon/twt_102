...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "twt_102.py"
...
def print_extra_stats(
    ...
    print(f" - X wins: {yellow}" f"{sum(x == 'X' for x in test_out):_}{reset}")
    print(f" - O wins: {yellow}" f"{sum(x == 'O' for x in test_out):_}{reset}")
    print(f" - Draw: {yellow}" f"{sum(x == 'D' for x in test_out):_}{reset}")
